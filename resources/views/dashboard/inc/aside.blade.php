        ...
        <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @role('admin|consultant')
                ...
                <li class="nav-item {{ request()->routeIs('dashboard.bookings.*') ? 'active' : '' }}">
                  ...
                  <li class="nav-item {{ request()->routeIs('dashboard.quick_consultations.*') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('dashboard.quick_consultations.index') }}">
                        <i class="la la-calendar-check"></i>
                        <span>الاستشارات السريعة</span>
                    </a>
                </li>
                {{-- Media --}}
